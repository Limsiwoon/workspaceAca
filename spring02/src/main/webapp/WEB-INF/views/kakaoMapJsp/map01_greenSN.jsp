...
=> Javascript 키 : da86d435670a3d063296cb97c9eef9cc (적용)

=> http://apis.map.kakao.com/web/sample/ 
=> 객체및 사용법 안내 : https://apis.map.kakao.com/web/documentation/
-->	
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=da86d435670a3d063296cb97c9eef9cc&libraries=services">
</script>	
...
//경기 용인시 기흥구 동백죽전대로455-10 : 용인 집 
//경기 성남시 분당구 돌마로 46  :  그린 컴퓨터아카데미 , GreenComputer
//경기 성남시 분당구 금곡동 167 이코노샤르망 5층 : 그린_별관 , (이코노샤르망 5층) 
let address = '경기 용인시 기흥구 동백죽전대로455-10' ;
let description = '내집이다' ; // description: 설명,묘사
...
geocoder.addressSearch(address, function(result, status) { 
	...
	if (status === daum.maps.services.Status.OK) { 
		...
		let marker = new daum.maps.Marker({ map: map, position: coords }); 
