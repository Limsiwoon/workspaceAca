...
public class MemberController {
	...
	public String log4jTest() {
		...
		/*
		 * ** Logger Level => TRACE > DEBUG > INFO > WARN > ERROR > FATAL(치명적인) => 실제는
		 * DEBUG, INFO, WARN 이 주로 활용됨.
		 */
		return "redirect:/";
...
//~~~~~~~~~~~~~~~~~~~~~~~loginForm~~~~~~~~~~~~~~~
	 ...
	 * => ver01 :return String
	 * 
	 * @RequestMapping(value={"/loginForm"}, method = RequestMethod.GET) // HTTP
	 * GET요청이 "/mlistsp" 경로로 들어왔을 때 특정 메서드를 실행하도록 지정하는 것 public String
	 * loginForm(Model model) { return "member/loginForm"; }
	 */

	/*
	 * => ver02 :return void => virename 이 생략 : 요청명과 동일한 viewName 을 찾음. =>
...
//~~~~~~~~~~~~~~~~~~~~~~login~~~~~~~~~~~~
	...
	public String login(HttpSession session, Model model, MemberDTO dto) {
		...
		// => mapping메서드의 인자와 동일한 컴럼명의 값은 자동으로 할당되어, 아래와 같이 request.getParameter를 작성하지
		// 않아도됨.
...
//~~~~~~~~~~~~~~~~~~~~~~joinForm~~~~~~~~~~
	...
	public String join(HttpServletRequest request, Model model, MemberDTO dto) throws IOException {
		...
		// (배포전) 나 혼자 개발 할 떄 저장하는 경로
			...
			realPath = "E:\\MTest\\IDESet\\apache-tomcat-9.0.85\\webapps\\spring02\\resources\\uploadImages\\";
		...
		if (!file.isFile()) { // 존재하지않는 경우
			String basicImagePath = "E:\\MTest\\workspaceAca\\workspaceAca\\spring02\\src\\main\\webapp\\resources\\images\\siba.png";
...
//		        mv.setViewName("redirect:mlist?message="+message);  
		...
		// => DefaultAnnotationHandlerMapping은 클래스와 메서드에 붙은 @RequestMapping 애노테이션 정보를
		// 결합해 최종 매핑정보를 생성한다.
